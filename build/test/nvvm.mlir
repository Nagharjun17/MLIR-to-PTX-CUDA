module {
  ...
  ^bb2:  // pred: ^bb1
    ...
    %37 = llvm.getelementptr inbounds|nuw %36[%31] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %38 = llvm.load %37 : !llvm.ptr -> f32
    %39 = llvm.fadd %35, %38 : f32
    %40 = llvm.extractvalue %11[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %41 = llvm.getelementptr inbounds|nuw %40[%31] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %39, %41 : f32, !llvm.ptr
    %42 = llvm.add %31, %12 : i64
    llvm.br ^bb1(%42 : i64)
  ^bb3:  // pred: ^bb1
    llvm.br ^bb4(%14 : i64)
  ...
  ^bb5:  // pred: ^bb4
    ...
    %46 = llvm.getelementptr inbounds|nuw %45[%43] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %47 = llvm.load %46 : !llvm.ptr -> f32
    %48 = llvm.extractvalue %30[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %49 = llvm.getelementptr inbounds|nuw %48[%43] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %50 = llvm.load %49 : !llvm.ptr -> f32
    %51 = llvm.intr.maximum(%47, %50) : (f32, f32) -> f32
    %52 = llvm.extractvalue %11[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %53 = llvm.getelementptr inbounds|nuw %52[%43] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %51, %53 : f32, !llvm.ptr
